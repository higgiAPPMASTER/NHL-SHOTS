...
.home{background:#0a1f0a;color:#00cc44;border:1px solid #1a3a1a;font-weight:700}
.away{background:#1f0a0a;color:#cc0000;border:1px solid #3a1a1a;font-weight:700}
.line-v{color:#FFB81C;font-weight:700;font-family:'Barlow Condensed',sans-serif;font-size:1rem}
.rate-hi{color:#00cc44;font-weight:700}
.rate-md{color:#FFB81C;font-weight:700}
.rate-lo{color:#cc0000;font-weight:700}
.score-v{font-family:'Barlow Condensed',sans-serif;color:#FFB81C;font-weight:900;font-size:1.2rem}
.sa-v{color:#666;font-size:.82rem}
