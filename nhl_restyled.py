...
/* CONNECTION BOX */
.conn-box{background:#161616;border:1px solid #262626;border-radius:16px;
  padding:30px;text-align:center;margin-bottom:20px}
.conn-box h2{font-size:1rem;font-weight:700;color:#f59e0b;font-family:'Playfair Display',serif;letter-spacing:1px;
  text-transform:uppercase;margin-bottom:8px}
.conn-box p{color:#666;font-size:.85rem;margin-bottom:20px}
.btn-connect{background:#f59e0b;color:#000;border:none;border-radius:8px;
...
.run-box.unlocked{border-color:#f59e0b}
...
.run-box.unlocked h2{color:#f59e0b}
...
.date-row input{background:#1a1a1a;color:#fff;border:1px solid #333;
  border-radius:6px;padding:10px 16px;font-size:.95rem;cursor:pointer;outline:none}
.date-row input:focus{border-color:#f59e0b}
.btn-run{background:linear-gradient(135deg,#f59e0b,#d97706);color:#000;border:none;border-radius:6px;
...
.chip{background:#111;border-top:3px solid #f59e0b;border-radius:8px;
  padding:16px 10px;text-align:center}
.chip .val{font-size:1.9rem;font-weight:900;color:#f59e0b}
.chip .lbl{font-size:.65rem;color:#555;text-transform:uppercase;letter-spacing:1px;margin-top:4px}

/* SECTION HEADER */
.sec{background:#111;border-left:4px solid #f59e0b;padding:10px 16px;
...
thead tr{border-bottom:2px solid #f59e0b}
th{background:#111;padding:12px 14px;text-align:left;font-size:.72rem;
  font-weight:900;text-transform:uppercase;letter-spacing:1px;color:#f59e0b;white-space:nowrap}
...
.rk-num{font-weight:900;color:#f59e0b;font-size:1.1rem}
...
.score{color:#f59e0b;font-weight:900;font-size:1.05rem}
.gray{color:#555;font-size:.8rem}
.est{background:#1a1200;color:#f59e0b;border:1px solid #332200;
...
.err-box{background:#1a0000;border:1px solid #f59e0b;border-radius:8px;
...
<nav style="position:fixed;top:0;width:100%;background:rgba(10,10,10,.95);backdrop-filter:blur(12px);border-bottom:1px solid #1c1c1c;z-index:100;padding:0 28px;height:72px;display:flex;align-items:center;justify-content:space-between">
  <span style="font-family:'Playfair Display',serif;font-size:1.5rem;font-weight:900;color:#f59e0b">Money<span style="color:#fff">Shots</span> 🏒</span>
  <span style="font-size:12px;color:#6b7280">NHL Shots on Goal Picks</span>
</nav>
...
function renderResults(d){
  ...
  if(d.ptsPicks && d.ptsPicks.length){
    h += '<div class="sec" style="margin-top:40px;border-left-color:#f59e0b">&#127944; Top ' + d.ptsPicks.length + ' Points Picks (1+ Point)</div>';
    h += buildPtsTable(d.ptsPicks, 1);
    if(d.ptsRest && d.ptsRest.length){
      h += '<div class="sec" style="margin-top:20px;border-left-color:#f59e0b">Also Qualified for Points — ' + d.ptsRest.length + ' More</div>';
